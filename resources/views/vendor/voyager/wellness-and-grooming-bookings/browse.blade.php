                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            @foreach($actions as $action)
                                                ...
                                                @endif
                                            @endforeach
                                            <button class="btn btn-success" data-toggle="modal" data-target="#rescheduleModal" data-id="{{ $data->id }}">Reschedule Appointment</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
@section('javascript')
    ...
    <script>
        ...
        $('#rescheduleForm').submit(function(e) {
            ...
            $.ajax({
                url: '/admin/reschedule-appointment-wellness/' + id,
                type: 'POST',
                data: {
                    _token: token,
                ...
                success: function(response) {
                    ...
                    location.reload(); // optional if you want to refresh
                },
                error: function(xhr) {
                    toastr.error('Failed to reschedule appointment.');
                }
            });
        });
