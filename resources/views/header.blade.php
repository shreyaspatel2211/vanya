...
<body>
    <header class="absolute left-0 top-0 w-full bg-[#F3F5FC70] shadow-lg z-[9] py-2">
        <div class="container mx-auto w-full flex justify-between items-center">
            ...
            <div class="text-white font-bold text-xl w-1/2 lg:w-1/4">
                <a href="/" class="w-[140px] md:w-[180px]">
                    <img src="{{ asset('dist/assets/images/logo.svg') }}" class="max-w-[100px]" alt="">
                </a>
            </div>
            <!-- Navbar (Desktop) -->
            ...
            <div class="w-1/4 hidden lg:flex justify-end">
                <div class="hidden lg:block lg:px-[30px] py-2">
                    <a href="/get_quote"
                        class="flex items-center btn bg-theme2 text-white rounded-full py-[20px] px-[32px] DMSans-medium text-sm ">Get
                        a Quote
                    </a>
                </div>
            </div>
            ...
            <div class="w-1/4 lg:hidden text-right">
                <button id="hamburger-icon" class="text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="#001e37"
                        class="h-8 w-8" id="hamburger">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16"></path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="#001e37"
                        class="h-6 w-6 hidden" id="close-icon">
        ...
        <div id="mobile-nav"
            class="nav-menu fixed inset-0 bg-white text-theme1 p-6 md:hidden transform z-20 translate-x-full">
