    ...
    <div class="pt-[123px] bg-[url('./dist/assets/images/about-bg.png')] bg-no-repeat bg-cover py-10 relative overflow-hidden">
        <div class="container py-[50px] lg:py-[150px] flex flex-col-reverse md:flex-row justify-between items-center">
            ...
            <div class="w-full text-white relative  max-w-[600px] mt-5 md:mt-0 banner-header">
                <h1 class="text-[#050509] text-[32px] md:text-[48px] DMSans-bold mb-7">Protect Your Pet Today – Get a Free Quote!</h1>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 lg:gap-6">
                                    ...
                                    <label class="cursor-pointer bg-[#F9F9F9] rounded-lg border border-[#E6E6E6]">
                                        ...
                                        <div class="border-2 border-transparent peer-checked:border-[#184175] rounded-lg p-6 text-center">
                                            <img src="./dist/assets/images/dog-insurance1.svg" alt="Option 1" class="w-24 h-24 mx-auto mb-8 rounded-lg">
                                    ...
                                    <label class="cursor-pointer bg-[#F9F9F9] rounded-lg border border-[#E6E6E6]">
                                        ...
                                        <div class="border-2 border-transparent peer-checked:border-[#184175] rounded-lg p-6 text-center">
                                            <img src="./dist/assets/images/cat-insurance1.svg" alt="Option 2" class="w-24 h-24 mx-auto mb-8 rounded-lg">
                                    ...
                                    <label class="cursor-pointer bg-[#F9F9F9] rounded-lg border border-[#E6E6E6]">
                                        <input type="radio" name="option" class="peer hidden">
                                        <div class="border-2 border-transparent peer-checked:border-[#184175] rounded-lg p-6 text-center">
                                            <img src="./dist/assets/images/companionpet-Insurance1.svg" alt="Option 3" class="w-24 h-24 mx-auto mb-8 rounded-lg">
                ...
                <div class="py-10 lg:py-20">
                    ...
                    <div class="faq-accordion flex flex-col items-center justify-center">
                        ...
                        <div class="w-full mb-3 rounded-[10px]">
                            ...
                            <label for="panel-1" class="relative  bg-white block text-theme2 font-bold text-base p-[20px] pl-[70px] mb-0 cursor-pointer rounded-[10px]">
                            What types of pet insuranceare available?
                            </label>
                            <div class="accordion__content overflow-hidden bg-grey-lighter">
                                <p class="!pt-0 bg-white text-[16px] rounded-b-[10px] accordion__body p-4 text-[#82828A]" id="panel1">Pet insurance comes in various types, including accident-only, accident and illness, and wellness plans. Each offers different coverage levels for vet bills, treatments, and routine care.</p>
                            </div>
                        </div>
                        <!-- Panel 2 -->
                        <div class="w-full mb-3 rounded-[10px]">
