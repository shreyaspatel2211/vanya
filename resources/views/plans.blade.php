...
<!-- ----------------------------------------------------------------------------------- -->
    ...
    <div class="py-6">
        <div class="container">
            ...
            <div class="grid grid-cols-3 gap-12 py-10">
        ...
        <div class="container">
            <div class="bg-[#F3F5FC] border border-[#9C9898] rounded-lg">
                <div class="grid grid-cols-4 gap-5 p-8">
                    ...
                    <div class="flex flex-col">
                        <div class="text-2xl DMSans-bold text-[#050509] group-hover:text-white mb-6">₹ 3500 <span class="text-base font-medium text-[#3AA9E9]">/month</span></div>
                        <a href="#" class="flex justify-center mt-auto w-full items-center btn bg-theme2 text-center text-white rounded-lg py-[6px] lg:py-[8px] px-[32px] DMSans-medium text-lg btn-shadow group-hover:bg-theme1">Get Started</a>
                    </div>
                </div>
            </div>
