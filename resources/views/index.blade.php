...
<div class="page">
    <!-- banner section -->
    <div class="pt-[123px] bg-[url('./dist/assets/images/banner-home.png')] bg-no-repeat bg-cover bg-right lg:bg-center py-10 relative overflow-hidden">
        <div class="container py-[50px] lg:py-[150px] flex flex-col-reverse md:flex-row justify-between items-center">
            ...
            <div class="w-full text-white relative max-w-[600px] mt-5 md:mt-0 banner-header">
                <h1 class="text-[#050509] text-[32px] md:text-[48px] DMSans-bold mb-7">{!! setting('home-page.banner_title') !!}
                </h1>
                <p class="text-[#333] relative mb-12 text-base">{!! setting('home-page.banner_description') !!}</p>
                <a href="#" class="flex w-fit items-center btn bg-theme1 text-white rounded-lg py-[10px] lg:py-[20px] px-[32px] DMSans-medium text-lg btn-shadow">Get a Quote
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="px-5 pt-3 relative bg-[#91AE8B]">
        <div class="flex items-center justify-center flex-wrap gap-5 lg:gap-20">
            <img src="./dist/assets/images/freepet-care.png" alt="" class="w-[120px] max-w-[150px] transform scale-x-[-1]">
            <h1 class="text-white py-2 text-[32px] md:text-[48px] DMSans-semibold text-center">{!! setting('home-page.banner_slogan') !!}</h1>
        </div>
    </div>
    <div class="py-10 bg-[#F9FAF9]">
        <div class="container">
            <div class="heading-wrapper mb-6 w-full text-center lg:text-right max-w-[500px] ml-auto">
                <div class="heading-label uppercase text-base DMSans-medium text-theme2 mb-1 tracking-[4px]">services</div>
                <h2 class="heading-title text-[38px] DMSans-bold text-theme2 mb-3">Our<span class="text-theme1"> services </span></h2>
                <p class="text-2xl DMSans-medium text-theme2">{!! setting('home-page.service_desc_1') !!}
                    {!! setting('home-page.service_desc_2') !!}
                </p>
            </div>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12">
                @foreach($services as $service)
                    <a href="{{ route('service.detail', $service->id) }}" class="group bg-white shadow-lg hover:bg-theme1 rounded-lg flex flex-col">
                        <div class="flex px-5 py-6 justify-between items-end">
                            <div class="text-[30px] uppercase DMSans-bold text-theme2 group-hover:text-white">{{ $service->service_name }}
                            </div>
                            <img class="w-[55px] h-[55px] block group-hover:hidden" src="./dist/assets/images/dog-insurance1.svg" alt="">
                            <img class="w-[55px] h-[55px] img-white hidden group-hover:block" src="./dist/assets/images/dog-insurance1.svg" alt="">
                        </div>
                        <span class="block px-5 pb-5 text-lg text-theme2 text-center w-full max-w-[220px] mx-auto group-hover:text-white">{{ $service->home_page_desc }}</span>
                        <img class="mt-auto w-fit" src="{{ Voyager::image($service->home_page_image) }}" alt="">
                    </a>
                @endforeach
                {{-- <div class="group bg-white shadow-lg hover:bg-theme1 rounded-lg flex flex-col">
                    ...
                    <span class="block px-5 pb-5 text-lg text-theme2 text-center w-full max-w-[220px] mx-auto group-hover:text-white">Health care plans for
                    cats & kittens</span>
                    <img class="mt-auto w-fit" src="./dist/assets/images/cat-insurance.png" alt="">
                </div>
                <div class="group bg-white shadow-lg hover:bg-theme1 rounded-lg flex flex-col">
                    <div class="flex px-5 py-6 justify-between items-end">
                    ...
                    <span class="block px-5 pb-5 text-lg text-theme2 text-center w-full max-w-[220px] mx-auto group-hover:text-white">Health care plans for
                    dogs & puppies</span>
                    <img class="mt-auto w-fit" src="./dist/assets/images/companionpet-Insurance.png" alt="">
                </div> --}}
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12">
                <div class="py-[30px] lg:py-[60px]">
                    <div class="heading-wrapper mb-6 w-full text-center lg:text-right max-w-[500px] ml-auto">
                        <div class="heading-label uppercase text-base DMSans-medium text-theme2 mb-1 tracking-[4px]">COvers</div>
                        <h2 class="heading-title text-[38px] DMSans-bold text-theme2 mb-3">Our<span class="text-theme1"> Offerings </span></h2>
                    ...
                    <div class="bg-white group rounded-[8px] hover:bg-theme1">
                        <a class="flex gap-10 p-6" href="#">
                            <div class="flex items-center">
                                ...
                                <div class="">
                                    <div class="group-hover:text-white text-xl text-[#020800] mb-2">Accident</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 pb-[60px]">
                ...
                {{-- <div class="bg-white group rounded-[8px] hover:bg-theme1">
                    <a class="flex gap-10 p-6" href="http://">
                        <div class="flex items-center">
                            <img class="w-fit mr-6 block group-hover:hidden" src="./dist/assets/images/h-offering3.svg" alt="">
                            <img class="img-white hidden group-hover:block w-fit mr-6" src="./dist/assets/images/h-offering3.svg" alt="">
                            <div class="">
                ...
                <div class="">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-10">
                        <div class="flex -space-x-3">
                            <img src="./dist/assets/images/team2.png" class="w-[64px] h-[64px] min-w-[64px] min-h-[64px] rounded-full border-2 border-white object-cover" alt="">
                            <img src="./dist/assets/images/team2.png" class="w-[64px] h-[64px] min-w-[64px] min-h-[64px] rounded-full border-2 border-white object-cover" alt="">
                            <img src="./dist/assets/images/team2.png" class="w-[64px] h-[64px] min-w-[64px] min-h-[64px] rounded-full border-2 border-white object-cover" alt="">
                        </div>
                        <p class="text-base text-[#98A393] max-w-[400px]">Reach Out to Our Professionals for Pet Parenting Advice</p>
                    </div>
                </div>
                <div>
                    <div class="heading-wrapper mb-6 w-full text-center lg:text-right max-w-[500px] ml-auto mb-[60px]">
                        <div class="heading-label uppercase text-base DMSans-medium text-theme2 mb-1 tracking-[4px]">Steps to follow</div>
                    ...
                    <ul class="list-decimal pl-6 lg:pl-0">
                        <li class="marker:text-theme1 marker:DMSans-black text-lg text-[#808380] pb-6 mb-6 border-b border-[#98A393]"><span class="DMSans-black text-theme1">{!! setting('home-page.guide_1_titel') !!}</span> - {!! setting('home-page.guide_1_desc') !!}</li>
                        <li class="marker:text-theme1 marker:DMSans-black text-lg text-[#808380] pb-6 mb-6 border-b border-[#98A393]"><span class="DMSans-black text-theme1">{!! setting('home-page.guide_2_title') !!}</span> - {!! setting('home-page.guide_2_desc') !!}</li>
                        <li class="marker:text-theme1 marker:DMSans-black text-lg text-[#808380] pb-6 mb-6 border-b border-[#98A393]"><span class="DMSans-black text-theme1">{!! setting('home-page.guide_3_title') !!}</span> - {!! setting('home-page.guide_3_desc') !!}</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-10">
                <div class="">
                    <div class="heading-wrapper w-full max-w-[600px] mr-auto mb-10">
                        <div class="heading-label uppercase text-base DMSans-medium text-white mb-1 tracking-[4px]">Why Choose Us</div>
                ...
                <div>
                    <img src="./dist/assets/images/why-choose-us.png" class="w-auto rounded-lg ml-auto" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="group bg-[#F3F5FC] border border-[#EAEEFF] p-10 hover:bg-theme2 rounded-lg">
                    <div class="text-2xl DMSans-bold text-[#050509] group-hover:text-white mb-6">₹ {{$plan->price}} <span class="text-base font-medium text-[#3AA9E9]">/month</span></div>
                    <div class="text-[32px] DMSans-bold mb-4 text-[#050509] group-hover:text-white">{{$plan->name}}</div>
                    <p class="text-base text-[#828284] pb-6 mb-6 border-b border-[#D0DBFF]">{{$plan->short_description}}</p>
                    ...
                    <a href="/plan" class="flex justify-center w-full items-center btn bg-theme2 text-center text-white rounded-lg py-[10px] lg:py-[20px] px-[32px] DMSans-medium text-lg btn-shadow group-hover:bg-theme1">Get a Quote
                    </a>
                </div>
                @endforeach
                {{-- <div class="group bg-[#F3F5FC] border border-[#EAEEFF] p-10 hover:bg-theme2 rounded-lg">
            ...
            <img src="./dist/assets/images/pricing.png" class="hidden lg:block absolute bottom-0 right-0" alt="">
        </div>
    </div>
    <div class="py-[54px] bg-[#64636A]">
        <div class="container">
            <div class="heading-wrapper w-full max-w-[600px] text-center lg:text-left mr-auto mb-10">
                <div class="heading-label uppercase text-base DMSans-medium text-white mb-1 tracking-[4px]">Key Features</div>
                <h2 class="heading-title text-[38px] DMSans-bold text-white mb-3">Our <span class="text-theme1">Exclusivity</span></h2>
                <p class="text-lg DMSans-medium text-white">Most calendars are designed for teams.
                ...
                @foreach($features as $feature)
                    <div class="px-5">
                        <div class="relative after:content-[''] after:absolute after:w-full after:h-full after:top-0 after:left-0 after:bg-[#000000] after:bg-opacity-30 after:rounded-lg">
                            <img src="{{ Voyager::image($feature->image) }}" class="w-full rounded-lg h-[380px]" alt="">
                            <div class="absolute z-10 bottom-0 left-0 py-5 px-5">
                                <div class="text-sm text-white DMSans-bold mb-3">{{ $feature->title }}</div>
        ...
        <div class="container">
            <div class="flex flex-col lg:flex-row items-end justify-between mb-20">
                <div class="heading-wrapper w-full text-center lg:text-left max-w-[500px] mr-auto">
                    <div class="heading-label uppercase text-base DMSans-medium text-theme2 mb-1 tracking-[4px]">Testimonials</div>
                    <h2 class="heading-title text-[38px] DMSans-bold text-theme2">Hear from <span class="text-theme1">Our Clients</span></h2>
                </div>
